    ...
    <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="list-group list-group-flush">
                    <c:forEach var="room" items="${rooms}">
                        <a href="${pageContext.request.contextPath}/vendor/chat?roomId=${room.id}" 
                           class="list-group-item list-group-item-action ${currentRoom.id == room.id ? 'active' : ''}">
                            <div class="d-flex w-100 justify-content-between">
                                <h6 class="mb-1">${room.customer.fullName}</h6>
                            </div>
                            <small>${room.customer.username}</small>
                        </a>
                    </c:forEach>
        ...
        <div class="col-md-8">
            <c:if test="${not empty currentRoom}">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Chat với ${currentRoom.customer.fullName}</h6>
                    </div>
